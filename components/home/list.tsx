          ...
          >
            ...
            <div className="flex items-start gap-4 mb-3">
              <div className="min-w-0 flex-1">
                <span className="text-[#211C1A] text-[24px] font-normal leading-[21.6px] font-eb-garamond">
                  {candidate.full_name}
                </span>
                <p className="text-[12px] text-[rgb(166,164,163)] mt-[8px] mb-[4px] font-bold leading-[-0.12px] h-[32px]">
                  {candidate.current_title.length >= 80
                    ? candidate.current_title.slice(0, 80) + "..."
